...
python main_IRT.py --max_epoch 25 --input demo/spatial_white_balance/Bedroom_input --processed demo/spatial_white_balance/Bedroom_processed --model spatial_white_balance --output ./result/spatial_white_balance --with_IRT 1 --IRT_initialization 1
